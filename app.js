...
const weddingConfig = {
  ...
  venue: '北京市朝阳区三里屯聚德楼',
  venueShort: '聚德楼',
  navigationUrl: 'https://surl.amap.com/e9zDnNYNfU5',
  schedule: [
    { label: '签到', time: '10:28', description: '领取今日任务，与老朋友相见' },
    { label: '仪式', time: '10:58', description: '见证拥抱、誓言与交换戒指' },
    { label: '喜宴', time: '11:28', description: '共享一场丰盛的秋日宴席' },
    { label: '合影', time: '11:28', description: '保存这一份快乐存档' },
  ],
}
